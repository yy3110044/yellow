...
<style type="text/css">
body{ background:#0066A8 url(admin/img/login_bg.png) no-repeat center 0px;}
...
<div class="login-wrap" style="height:270px;">
	...
	<table style="width:100%;" cellspacing="0">
		...
		<tr>
			<td height="60" valign="bottom"><input type="submit" value="登陆" class="btn btn-block btn-login"/></td>
		</tr>
		<tr><td style="color:red;">提示信息</td></tr>
	</table>
	</form>
</div>
